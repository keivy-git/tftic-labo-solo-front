...
import { FleaMarketForm } from '../forms/flea-market-form';
...
export class FleaMarketService {
  ...
  getOneLocation(zip: string | null, city: string | null) {
  ...
  postFleaMarket(newFleaMarket: FleaMarketForm): Observable<FleaMarketForm> {
    return this.httpClient.post<FleaMarketForm>(
      API_ENDPOINTS.fleaMarket.fleaMarketCreate,
      newFleaMarket,
    );
  }
}
